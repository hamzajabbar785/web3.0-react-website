      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-4">
        <div className="w-full lg:w-1/2 h-full p-4 flex items-center flex-col justify-center">
          ...
          <div className="grid grid-cols-2 mx-auto w-4/5 gap-10">
            <div className="flex justify-center items-center rounded-full shadow-md shadow-thPurple hover:scale-105 cursor-pointer duration-200 p-3">
              <FaLinkedin size={25} />
            </div>

            <div className="flex items-center justify-center rounded-full shadow-md shadow-thPurple hover:scale-105 cursor-pointer duration-200 p-3">
              <FaTwitter size={25} />
            </div>
          </div>
        </div>
